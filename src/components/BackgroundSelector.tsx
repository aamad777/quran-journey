...
export const BG_THEMES: Record<BackgroundPattern, BgThemeColors> = {
  ...
  geometric: {
    ...
    cardBg: "hsl(220 30% 12% / 0.85)",
  },
  mosque: {
    btnBg: "hsl(35 60% 45%)", btnText: "hsl(40 30% 97%)",
  ...
  calligraphy: {
    ...
    cardBg: "hsl(350 30% 12% / 0.85)",
  },
  tiles: {
    btnBg: "hsl(185 60% 40%)", btnText: "hsl(0 0% 100%)",
    btnOutlineBorder: "hsl(185 50% 45% / 0.5)", btnOutlineText: "hsl(200 50% 25%)",
    activeWordColor: "hsl(195 70% 45%)", activeWordGlow: "0 0 14px hsl(195 70% 40% / 0.5)",
    textColor: "hsl(200 40% 15%)", mutedText: "hsl(200 30% 35%)",
    cardBg: "hsl(190 20% 95% / 0.85)",
  },
};
